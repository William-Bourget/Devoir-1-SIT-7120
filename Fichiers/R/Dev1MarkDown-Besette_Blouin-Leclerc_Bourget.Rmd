---
title: "Devoir 1 STT-7120"
author: "Étienne Bessette, Philippe Blouin-Leclerc & William Bourget "
date: '2018-11-16'
output: 
  pdf_document:
    toc: false
...
On peut remplacer $(X'_{-i}X_{-i})^{-1}$ par l'équation 3.2. De plus, en partant du même principe que l'équation 3.1, il est possible de prouver que $(X'_{-i}Y_{-i}) = (X'Y) - x_iy_i$. En remplacent ces deux termes dans l'équation précédente on obtient :
...
summary(model_NB1_both)
```
La valeur relative du véhicule n'est pas associée au nombre de réclamations esperées. La relation entre la fréquence de sinistre et la valeur du véhicule ne fait pas beaucoup de sens. La valeur du véhicule serait plus associée à la sévérité des sinistres qu'à la fréquence. 